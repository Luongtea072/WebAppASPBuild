...
{
    public class MetterDatas1Controller : Controller
    {
        ...
        // GET: MetterDatas1/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: MetterDatas1/Create
